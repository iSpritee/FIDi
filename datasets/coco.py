...
class CocoDataset(Dataset):#通用数据集基类
    def __init__(
        self,
        img_dir=None,  #图像和标签路径
        label_dir=None,
        name_list_dir=None, #图像名列表的.txt文件路径
        split='train',
        stage='train',
    ):
        super().__init__()
...
class CocoClsDataset(CocoDataset):#分类任务数据集
    def __init__(
        self,
        img_dir=None,
        label_dir=None,
...
class CocoSegDataset(CocoDataset):#分割任务数据集
    def __init__(self,
                 img_dir=None,
                 label_dir=None,
                 name_list_dir=None,
